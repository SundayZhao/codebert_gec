...
from tools.seq2edit_metric import Seq2EditMetric
from overrides import overrides
from torch.nn.modules.linear import Linear
from allennlp.nn import util


@Model.register("seq2Edit")
class Seq2Edit(Model):
    def __init__(self, vocab: Vocabulary,
        ...
        super(Seq2Edit, self).__init__(vocab, regularizer)
    ...
    def get_metrics(self, reset: bool = False) -> Dict[str, float]:
        ...
        if self.metric is not None and not self.training:
            if reset:
                ...
                if self.save_metric == "+labels_accuracy":
                    ...
                    labels_accuracy_except_keep = 0
                    if 0 <= labels_accuracy_except_keep:
                        print('(best)Saving Model...')
                        self.logger.info('(best)Saving Model...')
        ...
        metrics_return = {"labels_accuracy": metrics_to_return["labels_accuracy"]}
